...
//        
//        NSURLConnection.sendAsynchronousRequest(NSURLRequest(URL: NSURL(string: "http://www.01by.com/Login/Hello.php?name=\(phoneNum.text)")!), queue: NSOperationQueue()) { (resq:NSURLResponse!, data:NSData!, error:NSError!) -> Void in
//            
//            
//            dispatch_async(dispatch_get_main_queue(), { () -> Void in
//                if let d = data {
//                    self.result.text = NSString(data: d, encoding: NSUTF8StringEncoding)
//                }
//            })
//           
//        }
